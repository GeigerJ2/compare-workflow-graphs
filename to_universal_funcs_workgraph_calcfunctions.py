# TODO: These are currently the functions required to run QE, _not_ to create the universal representation from WG.to_dict()
...
# __all__ = ('get_bulk_structure', 'generate_structures', 'collect_output', )
